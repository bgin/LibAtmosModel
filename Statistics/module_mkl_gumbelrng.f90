...
module mod_mkl_gumbelrng
 ...
 !==================================================================================85
    ...
    ! Major version
    integer(I32P), parameter, public :: MOD_MKL_GUMBELRNG_MAJOR = 1_I32P
    
    ! Minor version
    integer(I32P), parameter, public :: MOD_MKL_GUMBELRNG_MINOR = 0_I32P
    
    ! Micro version
    integer(I32P), parameter, public :: MOD_MKL_GUMBELRNG_MICRO = 0_I32P
    
    ! Module full version
    integer(I32P), parameter, public :: MOD_MKL_GUMBELRNG_FULLVER = 1000_I32P*MOD_MKL_GUMBELRNG_MAJOR + &
                                                                    100_I32P*MOD_MKL_GUMBELRNG_MINOR  + &
                                                                    10_I32P*MOD_MKL_GUMBELRNG_MICRO
    ...
    character(*),  parameter, public :: MOD_MKL_GUMBELRNG_BUILD_DATE = " "
     ...
     ! Module author info
    character(*),  parameter, public :: MOD_MKL_GUMBELRNG_AUTHOR = "Programmer: Bernard Gingold, e-mail: beniekg@gmail.com"
    ...
    type(MKLGumbelRNG_t) function constructor(nvalues,brng,seed,a,beta,  &
          ...
          if(aerr /= 0) then
              call handle_fatal_memory_error( logging,verbose,append,fname,  &
                                             "logger:197 --> mod_mkl_gumbelrng/constructor: Memory Allocation Failure !!", &
                                             "mod_mkl_gumbelrng/constructor:197 --> Memory Allocation Failure !!"   ,  &
                                              emsg,__LINE__ )
          end if
