...
module mod_mkl_weibullrng
 ...
 !==================================================================================85
    ...
    ! Major version
    integer(I32P), parameter, public :: MOD_MKL_WEIBULLRNG_MAJOR = 1_I32P
    
    ! Minor version
    integer(I32P), parameter, public :: MOD_MKL_WEIBULLRNG_MINOR = 0_I32P
    
    ! Micro version
    integer(I32P), parameter, public :: MOD_MKL_WEIBULLRNG_MICRO = 0_I32P
    
    ! Module full version
    integer(I32P), parameter, public :: MOD_MKL_WEIBULLRNG_FULLVER = 1000_I32P*MOD_MKL_WEIBULLRNG_MAJOR + &
                                                                     100_I32P*MOD_MKL_WEIBULLRNG_MINOR  + &
                                                                     10_I32P*MOD_MKL_WEIBULLRNG_MICRO
    ...
    ! Module author info
    character(*),  parameter, public :: MOD_MKL_WEIBULLRNG_AUTHOR = "Programmer: Bernard Gingold, e-mail: beniekg@gmail.com"
    ...
    type, public :: MKLWeibullRNG_t
          ...
          procedure, pass(this), public :: get_alpha
    ...
    type(MKLWeibullRNG_t) function constructor(nvalues,brng,seed,alpha,a,beta, &
          ...
          real(R64P),       intent(in) :: alpha,a,beta
          ...
          if(aerr /= 0) then
              call handle_fatal_memory_error( logging,verbose,append,fname ,   &
                                             "logger:201 --> mod_mkl_weibullrng/constructor: Memory Allocation Failure !!", &
                                             "mod_mkl_weibullrng/constructor:201 --> Memory Allocation Failure !!"   ,  &
                                             emsg,__LINE__ )
          end if
...
!DIR$ IF(USE_INLINING .EQ. 1)
    !DIR$ ATTRIBUTES INLINE :: get_alpha
!DIR$ ENDIF
    pure function get_alpha(this) result(alpha)
          class(MKLWeibullRNG_t), intent(in) :: this
          real(R64P) :: alpha
          alpha = this%m_alpha
    end function
