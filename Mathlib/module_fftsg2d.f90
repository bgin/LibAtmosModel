...
!====================================================================70
    subroutine cdft2d(n1max, n1, n2, isgn, a, t, ip, w)
      integer(I32P) :: n1max, n1, n2, isgn, ip(0 : *), n, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), t(0 : 8 * n2 - 1), &
                       w(0 : *)
      n = max(n1, 2 * n2)
      if (n .gt. 4 * ip(0)) then
...
!====================================================================70
    subroutine rdft2d(n1max, n1, n2, isgn, a, t, ip, w)
      integer(I32P) :: n1max, n1, n2, isgn, ip(0 : *), n, nw, nc, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), t(0 : 8 * n2 - 1), &
             w(0 : *)
      n = max(n1, 2 * n2)
      nw = ip(0)
...
!====================================================================70
!  subroutine: rdft2dsort
!====================================================================70
    subroutine rdft2dsort(n1max, n1, n2, isgn, a)
      integer(I32P) :: n1max, n1, n2, isgn, n2h, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), x, y
      n2h = n2 / 2
      if (isgn .lt. 0) then
          do j = n2h + 1, n2 - 1
              a(0, j) = a(n1 + 1, j)
...
!====================================================================70
    subroutine ddct2d(n1max, n1, n2, isgn, a, t, ip, w)
      integer(I32P) :: n1max, n1, n2, isgn, ip(0 : *), n, nw, nc, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), t(0 : 4 * n2 - 1),  &
             w(0 : *)
      n = max(n1, n2)
      nw = ip(0)
      if (n .gt. 4 * nw) then
...
!====================================================================70
!  subroutine: cdft2d_sub
!====================================================================70
    subroutine cdft2d_sub(n1max, n1, n2, isgn, a, t, ip, w)
      integer(I32P) :: n1max, n1, n2, isgn, ip(0 : *), i, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), t(0 : 8 * n2 - 1), & 
                       w(0 : *)
      if (n1 .gt. 4) then
          do i = 0, n1 - 8, 8
...
!====================================================================70
    subroutine rdft2d_sub(n1max, n1, n2, isgn, a)
      integer(I32P) :: n1max, n1, n2, isgn, n2h, i, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), xi
      n2h = n2 / 2
      if (isgn .lt. 0) then
          do i = 1, n2h - 1
              j = n2 - i
...
!====================================================================70
! subroutine: ddxt2d_sub
!====================================================================70
      subroutine ddxt2d_sub(n1max, n1, n2, ics, isgn, a, t,  &
        ip, w)
      integer(I32P) :: n1max, n1, n2, ics, isgn, ip(0 : *), i, j
      real(R64P)    :: a(0 : n1max - 1, 0 : n2 - 1), t(0 : 4 * n2 - 1), &
             w(0 : *)
      if (n1 .gt. 2) then
          do i = 0, n1 - 4, 4
