...
!====================================================================70
    subroutine cdft3d(n1max, n2max, n1, n2, n3, isgn, a, &
                     t, ip, w)
      integer(I32P) :: n1max, n2max, n1, n2, n3, isgn, ip(0 : *), n
      real(R64P) :: a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), & 
                    t(0 : *), w(0 : *)
      n = 2 * max(n2, n3)
      n = max(n, n1)
      if (n .gt. 4 * ip(0)) then
...
!====================================================================70  
     subroutine rdft3d(n1max, n2max, n1, n2, n3, isgn, a,           &
         t, ip, w)
      integer(I32P) :: n1max, n2max, n1, n2, n3, isgn, ip(0 : *),   &
         n, nw, nc
      real(R64P)    :: a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), &
                       t(0 : *), w(0 : *)
      n = 2 * max(n2, n3)
...
!====================================================================70
! subroutine:  rdft3dsort
!====================================================================70
    subroutine rdft3dsort(n1max, n2max, n1, n2, n3, isgn, a)
      integer(I32P) :: n1max, n2max, n1, n2, n3, isgn, n2h, n3h, j, k
      real(R64P)    :: a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), x, y
      n2h = n2 / 2
      n3h = n3 / 2
      if (isgn .lt. 0) then
          do k = 0, n3 - 1
...
!====================================================================70
!  subroutine:   xdft3da_sub
!====================================================================70
    subroutine xdft3da_sub(n1max, n2max, n1, n2, n3, icr,   &
         isgn, a, t, ip, w)
      integer(I32P) :: n1max, n2max, n1, n2, n3, icr, isgn,          &
         ip(0 : *), i, j, k
      real(R64P)    :: a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1),   &
         t(0 : *), w(0 : *)
      do k = 0, n3 - 1
...
!====================================================================70 
    subroutine rdft3d_sub(n1max, n2max, n1, n2, n3, isgn, a)
      integer(I32P) :: n1max, n2max, n1, n2, n3, isgn,         &
         n2h, n3h, i, j, k, l
      real(R64P)    ::  a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1), xi
      n2h = n2 / 2
      n3h = n3 / 2
      if (isgn .lt. 0) then
          do k = 1, n3h - 1
...
!====================================================================70         
! subroutine:  ddxt3da_sub
!====================================================================70
    subroutine ddxt3da_sub(n1max, n2max, n1, n2, n3, ics,    &
         isgn, a, t, ip, w)
      integer(I32P) ::  n1max, n2max, n1, n2, n3, ics, isgn,           &
         ip(0 : *), i, j, k
      real(R64P)    ::  a(0 : n1max - 1, 0 : n2max - 1, 0 : n3 - 1),    &
         t(0 : *), w(0 : *)
      do k = 0, n3 - 1
