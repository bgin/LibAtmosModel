...
!====================================================================70
    subroutine cdft(n, isgn, a, ip, w)
      integer(I32P) :: n, isgn, ip(0 : *), nw
      real(R64P)    :: a(0:n-1), w(0:*)
      nw = ip(0)
      if (n .gt. 4 * nw) then
          nw = n / 4
          call makewt(nw, ip, w)
...
!====================================================================70
    subroutine rdft(n, isgn, a, ip, w)
      integer(I32P) ::  n, isgn, ip(0 : *), nw, nc
      real(R64P)    ::  a(0 : n - 1), w(0 : *), xi
      nw = ip(0)
      if (n .gt. 4 * nw) then
          nw = n / 4
          call makewt(nw, ip, w)
...
!====================================================================70
     subroutine ddct(n, isgn, a, ip, w)
      integer(I32P) ::  n, isgn, ip(0 : *), j, nw, nc
      real(R64P)    ::  a(0 : n - 1), w(0 : *), xr
      nw = ip(0)
      if (n .gt. 4 * nw) then
          nw = n / 4
          call makewt(nw, ip, w)
...
!====================================================================70
    subroutine dfct(n, a, t, ip, w)
      integer(I32P) :: n, ip(0 : *), j, k, l, m, mh, nw, nc
      real(R64P)    :: a(0 : n), t(0 : n / 2), w(0 : *), xr, xi, yr, yi
      nw = ip(0)
      if (n .gt. 8 * nw) then
          nw = n / 8
          call makewt(nw, ip, w)
...
!====================================================================70
    subroutine dfst(n, a, t, ip, w)
      integer(I32P) :: n, ip(0 : *), j, k, l, m, mh, nw, nc
      real(R64P)    :: a(0 : n - 1), t(0 : n / 2 - 1), w(0 : *), xr, xi, yr, yi
      nw = ip(0)
      if (n .gt. 8 * nw) then
          nw = n / 8
          call makewt(nw, ip, w)
...
!====================================================================70
    subroutine makewt(nw, ip, w)
      integer(I32P) :: nw, ip(0 : *), j, nwh, nw0, nw1
      real(R64P)    :: w(0 : nw - 1), delta, wn4r, wk1r, wk1i, wk3r, wk3i
      ip(0) = nw
      ip(1) = 1
      if (nw .gt. 2) then
          nwh = nw / 2
...
!====================================================================70
    subroutine makeipt(nw, ip)
      integer(I32P) :: nw, ip(0 : *), j, l, m, m2, p, q
      ip(2) = 0
      ip(3) = 16
      m = 2
      l = nw
...
!====================================================================70
    subroutine makect(nc, ip, c)
      integer(I32P) :: nc, ip(0 : *), j, nch
      real(R64P)    :: c(0 : nc - 1), delta
      ip(1) = nc
      if (nc .gt. 1) then
          nch = nc / 2
...
!====================================================================70
    subroutine cftfsub(n, a, ip, nw, w)
      integer(I32P) :: n, ip(0 : *), nw
      real(R64P)    :: a(0 : n - 1), w(0 : nw - 1)
      if (n .gt. 8) then
          if (n .gt. 32) then
...
!====================================================================70
    subroutine bitrv2(n, ip, a)
      integer(I32P) :: n, ip(0 : *), j, j1, k, k1, l, m, nh, nm
      real(R64P)    :: a(0 : n - 1), xr, xi, yr, yi
      m = 1
      l = n / 4
      do while (l .gt. 8)
          m = m * 2
...
!====================================================================70
    subroutine bitrv216(a)
      real(R64P) :: a(0 : 31), x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i
      real(R64P) :: x5r, x5i, x7r, x7i, x8r, x8i, x10r, x10i
      real(R64P) :: x11r, x11i, x12r, x12i, x13r, x13i, x14r, x14i
      x1r = a(2)
      x1i = a(3)
      x2r = a(4)
      x2i = a(5)
...
!====================================================================70
!  subroutine: bitrv216neg
!====================================================================70
    subroutine bitrv216neg(a)
      real(R64P) :: a(0 : 31), x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i
      real(R64P) :: x5r, x5i, x6r, x6i, x7r, x7i, x8r, x8i
      real(R64P) :: x9r, x9i, x10r, x10i, x11r, x11i, x12r, x12i
      real(R64P) :: x13r, x13i, x14r, x14i, x15r, x15i
      x1r = a(2)
      x1i = a(3)
      x2r = a(4)
      x2i = a(5)
...
!====================================================================70
    subroutine bitrv208(a)
      real(R64P) :: a(0 : 15), x1r, x1i, x3r, x3i, x4r, x4i, x6r, x6i
      x1r = a(2)
      x1i = a(3)
      x3r = a(6)
      x3i = a(7)
...
!====================================================================70
!  subroutine: bitrv208neg
!====================================================================70
    subroutine bitrv208neg(a)
      real(R64P) :: a(0 : 15), x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i
      real(R64P) :: x5r, x5i, x6r, x6i, x7r, x7i
      x1r = a(2)
      x1i = a(3)
      x2r = a(4)
      x2i = a(5)
...
!====================================================================70
    subroutine cftf1st(n, a, w)
      integer(I32P) :: n, j, j0, j1, j2, j3, k, m, mh
      real(R64P)    :: a(0 : n - 1), w(0 : *)
      real(R64P)    :: wn4r, csc1, csc3, wk1r, wk1i, wk3r, wk3i
      real(R64P)    :: wd1r, wd1i, wd3r, wd3i
      real(R64P)    :: x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i
      real(R64P)    :: y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i
      mh = n / 8
      m = 2 * mh
      j1 = m
      j2 = j1 + m
...
!====================================================================70
    subroutine cftrec4(n, a, nw, w)
      integer(I32P) :: n, nw, cfttree, isplt, j, k, m
      real(R64P)    :: a(0 : n - 1), w(0 : nw - 1)
      m = n
      do while (m .gt. 512)
          m = m / 4
...
!====================================================================70
    integer function cfttree(n, j, k, a, nw, w)
      integer(I32P) :: n, j, k, nw, i, isplt, m
      real(R64P)    :: a(0 : j - 1), w(0 : nw - 1)
...
!====================================================================70
    subroutine cftmdl1(n, a, w)
      integer(I32P) :: n, j, j0, j1, j2, j3, k, m, mh
      real(R64P)    :: a(0 : n - 1), w(0 : *)
      real(R64P)    :: wn4r, wk1r, wk1i, wk3r, wk3i
      real(R64P)    :: x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i
      mh = n / 8
      m = 2 * mh
      j1 = m
...
!====================================================================70
    subroutine cftmdl2(n, a, w)
      integer(I32P) :: n, j, j0, j1, j2, j3, k, kr, m, mh
      real(R64P)    :: a(0 : n - 1), w(0 : *)
      real(R64P)    :: wn4r, wk1r, wk1i, wk3r, wk3i, wd1r, wd1i, wd3r, wd3i
      real(R64P)    :: x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i
      real(R64P)    :: y0r, y0i, y2r, y2i
      mh = n / 8
      m = 2 * mh
      wn4r = w(1)
      j1 = m
...
!====================================================================70
    subroutine cftf161(a, w)
      real(R64P) :: a(0 : 31), w(0 : *), wn4r, wk1r, wk1i
      real(R64P) :: x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i
      real(R64P) :: y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i
      real(R64P) :: y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i
      real(R64P) :: y8r, y8i, y9r, y9i, y10r, y10i, y11r, y11i
      real(R64P) :: y12r, y12i, y13r, y13i, y14r, y14i, y15r, y15i
      wn4r = w(1)
      wk1r = w(2)
      wk1i = w(3)
      x0r = a(0) + a(16)
...
!====================================================================70
    subroutine cftf162(a, w)
      real(R64P) :: a(0 : 31), w(0 : *)
      real(R64P) :: wn4r, wk1r, wk1i, wk2r, wk2i, wk3r, wk3i
      real(R64P) :: x0r, x0i, x1r, x1i, x2r, x2i
      real(R64P) :: y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i
      real(R64P) :: y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i
      real(R64P) :: y8r, y8i, y9r, y9i, y10r, y10i, y11r, y11i
      real(R64P) :: y12r, y12i, y13r, y13i, y14r, y14i, y15r, y15i
...
!====================================================================70
    subroutine cftf081(a, w)
      real(R64P) :: a(0 : 15), w(0 : *)
      real(R64P) :: wn4r, x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i
      real(R64P) :: y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i
      real(R64P) :: y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i
      wn4r = w(1)
      x0r = a(0) + a(8)
...
!====================================================================70
    subroutine cftf082(a, w)
      real(R64P) :: a(0 : 15), w(0 : *)
      real(R64P) :: wn4r, wk1r, wk1i, x0r, x0i, x1r, x1i
      real(R64P) :: y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i
      real(R64P) :: y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i
      wn4r = w(1)
      wk1r = w(2)
...
!====================================================================70
    subroutine cftf040(a)
      real(R64P) ::  a(0 : 7), x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i
      x0r = a(0) + a(4)
      x0i = a(1) + a(5)
      x1r = a(0) - a(4)
      x1i = a(1) - a(5)
...
!====================================================================70
    subroutine rftfsub(n, a, nc, c)
      integer(I32P) :: n, nc, j, k, kk, ks, m
      real(R64P)    :: a(0 : n - 1), c(0 : nc - 1), wkr, wki, xr, xi, yr, yi
      m = n / 2
      ks = 2 * nc / m
      kk = 0
      do j = 2, m - 2, 2
...
!====================================================================70
    subroutine dctsub(n, a, nc, c)
      integer(I32P) :: n, nc, j, k, kk, ks, m
      real(R64P)    :: a(0 : n - 1), c(0 : nc - 1), wkr, wki, xr
      m = n / 2
      ks = nc / n
      kk = 0
      do j = 1, m - 1
