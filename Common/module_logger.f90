...
#include "Config.fpp"
 ...
 ! Tab:10,11 col - Type , function and subroutine code blocks.
    ...
    ! File version major
    integer(I32P), parameter, public :: module_logger_major = 1
    
    ! File version minor
    integer(I32P), parameter, public :: module_logger_minor = 0
    
    ! File version micro(patch)
    integer(I32P), parameter, public :: module_logger_micro = 0
    
    ! File full version
    integer(I32P), parameter, public :: module_logger_version = 1000*module_logger_major+100*module_logger_minor + &
                                                                10*module_logger_micro
    
    ! Creation date
    character(*), parameter,  public :: module_logger_creation_date="15-06-2017 11:56 +00200 (Thr 15 Jun 2017 GMT+2)"
    
    ! File build date/time , should be set manually after every recompilation
    character(*), parameter,  public :: module_logger_build_date=" "
    
    ! Module name
    character(*), parameter,  public :: module_logger_name="module_logger"
    
    ! Module Author
    character(*), parameter,  public :: module_author="Changed and adapted by: Bernard Gingold, e-mail: beniekg@gmail.com"
    
    ! Module short description
    character(*), parameter,  public :: module_description="Events logging module"
    ...
    ! File name
    character(*), parameter, private :: file_name="module_logger.f90"
    
    ! Module name
    character(*), parameter, private :: mod_name="module_logger"
     !============================================50
    ...
    pure function get_module_logger_version_major() result(ver_major)
          implicit none
          ! Locals/return
          integer(I32P) :: ver_major
          ver_major = module_logger_major
    end function
    ...
    pure function get_module_logger_version_minor() result(ver_minor)
          implicit none
          ! Locals/return
          integer(I32P) :: ver_minor
          ver_minor = module_logger_minor
    end function
    ...
    pure function get_module_logger_version_micro() result(ver_micro)
          implicit none
          ! Locals/return
          integer(I32P) :: ver_micro
          ver_micro = module_logger_micro
    end function
    ...
    pure function get_module_logger_full_version() result(ver_full)
         implicit none
         ! Locals/return
         integer(I32P) :: ver_full
         ver_full = module_logger_version
    end function
    ...
    pure function get_module_creation_date() result(cdate)
          ...
          cdate = module_logger_creation_date
    end function
    ...
    pure function get_module_build_date() result(bdate)
          ...
          ! Start of executable statements
          bdate = module_logger_build_date
    end function
    
    !============================================50
    !  function:
    !             get_module_logger_name
    !   Purpose:
    !             Returns this module name
    !============================================50
    pure function get_module_logger_name() result(modname)
          implicit none
          ! Locals returns
          character(len=15) :: modname
          ! Start of execuatble statements
          modname = module_logger_name
    end function
...
!DIR$ ENDIF
    ...
    !============================================50  
    integer(I32P) function log_get_freeunit()
          use ISO_FORTRAN_ENV, only : ERROR_UNIT
          implicit none
          ! Locals
          integer(I32P)            :: iunit,ios
          logical(I32P)            :: lopen,unit_found
          logical(I32P), parameter :: maxunits = 100
          ! Start of executable statements
          iunit = 0_I32P
          unit_found = .false.
          log_get_freeunit = 0_I32P
          do iunit = 1, maxunits
